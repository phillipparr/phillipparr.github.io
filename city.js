...
// API request
     fetch (query_url)
       ...
       .then (function(data) {
          ...
          function intscores (results) {
            var intscores = [];
            for (var i in results) {
              var intscore = Math.round(results[i].score_out_of_10);
...
// NEWS API
// This function joins the parameters to make the proper url for the query
...
// This function is for the NewsAPI request, it's called above in the random and drop down functions
function newsAPI (city) {
  var url = "https://newsapi.org/v2/everything";
  let params = { //parameters for the query url
    q:city,
    from:"2017-12-10",
    sortBy: "popularity",
